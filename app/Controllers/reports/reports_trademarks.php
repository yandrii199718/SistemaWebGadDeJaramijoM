...
$html = '<div></div><table cellpadding="4" style="border: 1px solid '.$colorE.'; font-size: 12px;">
		<tr>
			<th width="10%" style="border: 1px solid '.$colorE.';">#</th>
			<th width="90%" style="border: 1px solid '.$colorE.';">Nombre Marca</th>
		</tr>';



//echo '<pre>'; var_dump($usuarios); exit;
foreach($marcas as $key => $dato){

  $nombre = $dato["nombre_marca"];



  $html .= '<tr style="font-size: 12px; color: #2E2E2E;">
    <td style="border: 1px solid '.$colorE.';">'.$key.'</td>
    <td style="border: 1px solid '.$colorE.';">'.$nombre.'</td>
