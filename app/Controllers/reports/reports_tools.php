...
$html = '<div></div><table cellpadding="4" style="border: 1px solid '.$colorE.'; font-size: 12px;">
		<tr>
			...
			<th width="15%" style="border: 1px solid '.$colorE.';">Nombre herramienta</th>
			<th width="25%" style="border: 1px solid '.$colorE.';">Observación</th>
      <th width="15%" style="border: 1px solid '.$colorE.';">marca</th>
      <th width="15%" style="border: 1px solid '.$colorE.';">area</th>
...
foreach($herramientas as $key => $dato){
  ...
  $html .= '<tr style="font-size: 12px; color: #2E2E2E;">
    ...
    <td style="border: 1px solid '.$colorE.';">'.$nombreHerramienta.'</td>
